...
[Website](https://sift-site.vercel.app) · [Download the notarized DMG](https://github.com/aka-kika/sift/releases/latest) · [What it does](#what-sift-does) · [Privacy](#privacy) · [Docs](#docs)
...
| | |
|---|---|
| [Landing page](site/) | Marketing site — live at [sift-site.vercel.app](https://sift-site.vercel.app), deployed from this folder (see site/README.md) |
