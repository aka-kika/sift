...
- **Workflow profile** — an editable local profile that analyses are scored against (Settings → Profile).
...
- **Export to CSV** — the full audit (name, bundle ID, version, score, recommendation,
